...
const FAITH_OPTIONS = ['Christianity', 'Islam', 'Traditional African', 'Other', 'Prefer not to say'];

const FaithStep: React.FC<Props> = ({ faith, onUpdate, onNext, onBack, onSkip, currentStep, totalSteps }) => {
  const [selected, setSelected] = useState(faith);
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        <Text style={styles.subtitle}>Your faith</Text>
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 18, color: '#FFFFFF', fontWeight: '600', marginBottom: 16 },
  option: { padding: 16, marginBottom: 12, backgroundColor: 'rgba(255, 255, 255, 0.15)', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.2)' },
  optionSelected: { backgroundColor: '#FF6B9D', borderColor: '#FF6B9D' },
  optionText: { fontSize: 16, color: 'rgba(255, 255, 255, 0.9)' },
